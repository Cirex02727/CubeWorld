...
void Shader::SetUniform1uiv(const std::string& name, int count, unsigned int* value)
{
...
void Shader::SetUniform2fv(const std::string& name, int count, float* values)
{
...
void Shader::SetUniform3fv(const std::string& name, int count, float* values)
{
