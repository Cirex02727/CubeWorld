...
public:
	...
	void BeginSession(const std::string& name, const std::string& filepath = "results.json")
	{
		...
		if (m_CurrentSession)
		{
			std::cout << "Instrumentor::BeginSession('" << name << "') when session '" << m_CurrentSession->Name << "' already open." << std::endl;
			InternalEndSession();
		}
...
namespace InstrumentorUtils {
	...
	#define PROFILE_SCOPE_LINE(name, line) constexpr auto fixedName##line = InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
